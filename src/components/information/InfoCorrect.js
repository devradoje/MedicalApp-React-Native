...
export default class InfoCorrect extends Component {
            ...
            <View style={styles.container}>
                <View style = {styles.top}>
                    <Image 
                        ...
                        source={require('../../assets/images/info_correct.png')} 
                        resizeMode="contain"
                    />
                </View>
                <View style={styles.titleContainer}>
                    <Text style={styles.titleText}>Votre observance est correcte !</Text>
                </View>
                <View style={styles.descContainer}>
                    <Text style={styles.descText}>Pour vous aider à améliorer l’observance, cherchez les causes de mauvaises observances en répondant au questionnaire QueObs. </Text>
                </View>
